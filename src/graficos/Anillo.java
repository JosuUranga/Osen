        ...
        protected void drawItem(Graphics2D g2, int section, 
            ...
            if (currentPass == 1 && section == 0) {
                ...
                if (this.getDataset().getKey(0).equals(controladorIdioma.getListaPalabras().get(19))) {
                	TextUtilities.drawAlignedString(this.getDataset().getValue(this.getDataset().getKey(0))+"/"+"450ppm", g2, 
                	...
                	TextUtilities.drawAlignedString(this.getDataset().getValue(this.getDataset().getKey(0))+"/"+"500ppb", g2, 
                            (float) dataArea.getCenterX(), 
                            (float) dataArea.getCenterY(),  
                            TextAnchor.CENTER);
                }else if(this.getDataset().getKey(0).equals(controladorIdioma.getListaPalabras().get(18))) {
                	TextUtilities.drawAlignedString(this.getDataset().getValue(this.getDataset().getKey(0))+"/"+"50ºC", g2, 
                            (float) dataArea.getCenterX(), 
                            (float) dataArea.getCenterY(),  
                            TextAnchor.CENTER);
                }
